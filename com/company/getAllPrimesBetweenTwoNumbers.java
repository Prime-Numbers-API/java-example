...
public class getAllPrimesBetweenTwoNumbers {
    public static void main(String[] args) {
        ...
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(base_url + "/get-all-primes-between-two-numbers.php?key=" + apiKey + "&include_explanations=" + include_explanations + "&include_prime_types_list=" + include_prime_types_list + "start=" + start + "end=" + end + "&language=" + language)).build();
